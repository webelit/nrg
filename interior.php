			...
			<div class="wrapper">
				<header class="header">
					...
					<div class="header_cont">
						<h1 class="h1">Рекламные конструкции и интерьерные<br>решения для бизнеса</h1>
				...
				<main class="content">
					<div class="cont">
						...
						<h2 class="rek_h2">Наиболее популярные варианты уличных конструкций</h2>
					</div>
					<div class="cont">
						<div class="flex">
							<div class="vidi_catalog">
								<img src="images/inter_1.jpg" alt="Стоящие отдельно стелы">
								<h3 class="vidi_catalog_h3">Стоящие отдельно стелы, указатели, штендеры, рекламные скамейки</h3>
							</div>
							<div class="vidi_catalog">
								<img src="images/inter_2.jpg" alt="Объемные надписи">
								<h3 class="vidi_catalog_h3">Объемные надписи, демонстрационные щиты</h3>
							</div>
							<div class="vidi_catalog">
								<img src="images/inter_3.jpg" alt="Световые короба">
								<h3 class="vidi_catalog_h3">Световые короба</h3>
							</div>
							<div class="vidi_catalog">
								<img src="images/inter_4.jpg" alt="Медиафасады, бегущие строки">
								<h3 class="vidi_catalog_h3">Медиафасады, бегущие строки</h3>
							</div>
							...
							<p class="vidi">Для оформления торговых точек и залов ресторанов используют совершенно иные решения:</p>
							<div class="flex">
								<div class="vidi_catalog">
									<img src="images/inter_5.jpg" alt="Вывески в интерьере">
									<h3 class="vidi_catalog_h3">Вывески в интерьере</h3>
									<p>привлекают взгляд и гармонируют с любой обстановкой.</p>
								</div>
								<div class="vidi_catalog">
									<img src="images/inter_6.jpg" alt="Фотообои и фотозоны">
									<h3 class="vidi_catalog_h3">Фотообои и фотозоны</h3>
									<p>вносят элемент неординарности и создают уютную атмосферу.</p>
								</div>
								<div class="vidi_catalog">
									<img src="images/inter_7.jpg" alt="Стойки">
									<h3 class="vidi_catalog_h3">Стойки</h3>
									<p>используют для выкладки промо-продукции и информационных листовок.</p>
								</div>
								<div class="vidi_catalog">
									<img src="images/inter_8.jpg" alt="Пресс-воллы">
									<h3 class="vidi_catalog_h3">Пресс-воллы</h3>
									<p>для натяжки демонстрационных баннеров удобны при проведении конференций, детских праздников и свадеб.</p>
								</div>
								<p>Правильная реклама включает множество обязательных элементов, но имеет нюансы в технике изготовления. Выбирая формат, важно учитывать специфику работы компании. Что подходит для банка, не годится для развлекательного центра, поэтому разрабатывать конструкции и подбирать информационное наполнение нужно в индивидуальном порядке, привлекая профильных специалистов.</p>
							</div>
						</div>
					</div>
					<div class="cont">
