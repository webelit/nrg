			...
			<div class="wrapper">
				...
				<main class="content">
					<div class="cont">
						...
						<p class="vid">Навигационные указатели условно разделяют на:</p>
					</div>
					<div class="cont">
						<div class="flex">
							<div class="vidi_catalog_3">
								<img src="images/tabl_1.jpg" alt="Уличные инсталляции">
								<p class="vidi_catalog_h3">адресные таблички</p>
							</div>
							<div class="vidi_catalog_3">
								<img src="images/tabl_2.jpg" alt="Ландшафтные произведения искусства">
								<p class="vidi_catalog_h3">рекламные вариации</p>
							</div>
							<div class="vidi_catalog_3">
								<img src="images/tabl_3.jpg" alt="Световые конструкции">
								<p class="vidi_catalog_h3">информационные мини-плакаты</p>
							</div>
							<p class="rek">Поскольку вывески часто устанавливают на открытом пространстве, их изготавливают из прочных, долговечных материалов, неуязвимых к неблагоприятным погодным условиям и агрессивному механическому воздействию. Наиболее востребованы таблички из ПВХ. Пластик – легкий и износостойкий материал, который неприхотлив в уходе. Воспроизведение изображения производится методом прямой печати или путем предварительного нанесения на пленку с последующим накатом на основу.</p>
							<p class="rek">Интерьерная печать выполняется полноцветными плоттерами и воспроизводит мельчайшие детали и полутона изображения.</p>
							<p class="rek">Изготовление табличек посредством аппликации немецкой пленкой ORACAL – инновационная методика, позволяющая передать насыщенность оттенков. Преимуществами технологии являются стойкость к природным капризам и ценовая доступность.</p>
							<p class="rek">Еще один популярный вариант – таблички из композита. Продукция имитирует зеркальное серебро либо золото и подчеркивает корпоративный стиль организации.</p>
							<p class="rek">Функционал табличек широк и разнообразен. Производители предлагают богатый выбор материалов, вариантов дизайна и ценовых категорий. Удачно подобранная вывеска способна украсить фасад и привлечь клиентов.</p>
						</div>
					</div>
					<div class="cont">
