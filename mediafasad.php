			...
			<div class="wrapper">
				<header class="header">
					...
					<div class="header_cont">
						<h1 class="h1">Медиа фасад<br></h1>
						<p>Предлогаем арендовать наш медиа фасад</p>
						<div class="button">
					...
					<div class="cont">
						<h2 class="h2">Медиафасад</h2>
						<div class="flex">
						<img src="/images/mediafasad.jpg" alt="" class="mf_jpg">
							<p class="mf_p">
					Реклама на самом крупном медиафасаде города<br><br>


Уникальный и привлекательный вид рекламы для нашего города:<br>

самый большой экран Юга России на самом высоком здании в центре города Ставрополя<br>


трафик — более 57 00 жителей в день<br>


в непосредственной близости — торговые центры, рестораны, бутики, парк и администрация, а также прогулочные зоны и проезжая часть<br>


размещение на медиафасаде по цене билборда
							</p>
						</div>
					</div>
					<div class="confidence">
						...
						<div class="flex adv">
							...
							<div class="conf">
								...
								<p>НАДЕЖНОСТЬ</p>
								<span>собственное производство<br>и качественное оборудование</span>
							</div>
						</div>
					</div>
					<div class="order">
