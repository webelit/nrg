					...
					<div class="confidence">
							...
							<div class="flex adv_4">
								...
								<div class="conf">
									...
									<p>устойчивость к неблагоприятным погодным условиям</p>
								</div>
							</div>
						</div>
					<div class="cont">
