...
<body>
	<div class="flex">
		...
		<div class="cont_right">
			<div class="wrapper">
				<header class="header">
					<img src="images/head_11.jpg" alt="" class="header_img">
					<div class="header_cont">
						<h1 class="h1">Дизайн рекламной продукции - неотъемлемый<br>этап продвижения товара</h1>
						<p>Дизайн рекламной продукции призван подогнать демонстрационные конструкции<br>под фирменный стиль компании. Дизайнеры создают уникальные макеты с учетом<br>специфики товара</p>
						<div class="button">
				...
				<main class="content">
					<div class="cont">
						<p class="rek">
							Рекламные конструкции, широко используемые в розничной торговле и на различных выставках, позволяют привлечь больше потребителей, выделить новинки или акционные товары, красиво оформить предлагаемую продукцию. Этажерки, горки, промостойки, визитницы, прессволлы, дегустационные стойки, ростовые фигуры притягивают взгляд и удобны для продвижения изделий. Над созданием макета каждой каркасной конструкции работают опытные специалисты, учитывающие фирменный образ компании-заказчика и пожелания клиента. Грамотно разработанный дизайн рекламной продукции позволяет изготовить изделие в узнаваемом стиле и идеально подходящее для демонстрации достоинств продвигаемого продукта.
						</p>
						<h2 class="rek_h2">Тонкости работы</h2>
						<p class="vid">
							От дизайн-проекта демонстрационной конструкции зависит, насколько удачной станет рекламная кампания фирмы. Разработка успешного проекта – задача сложная, поэтому необходимо отыскать специалиста, который поймет идею клиента и сможет создать макет с первого раза. Наше агентство поможет в обеспечении бизнеса подходящими инструментами продвижения товара или услуги.
						</p>
					</div>
					<div class="cont design">
						<div class="design_3">
							<img src="/images/design_1.svg" alt="Cтиль подачи материала должен быть лаконичен и понятен целевой аудитории">
							<p>Cтиль подачи материала должен быть лаконичен и понятен целевой аудитории</p>
						</div>
						<div class="design_3">
							<img src="/images/design_2.svg" alt="контент обязан соответствовать психологии потенциального потребителя">
							<p>контент обязан соответствовать психологии потенциального потребителя</p>
						</div>
						<div class="design_3">
							<img src="/images/design_3.svg" alt="органично подобранные цвета, формы, размер шрифта и изображений создают запоминающийся образ">
							<p>органично подобранные цвета, формы, размер шрифта и изображений создают запоминающийся образ</p>
						</div>
					</div>
					<div class="cont">
						<div class="flex">
							<div class="vidi_catalog">
								<img src="images/design_1.jpg" alt="Уличные инсталляции">
							</div>
							<div class="vidi_catalog">
								<img src="images/design_2.jpg" alt="Ландшафтные произведения искусства">
							</div>
							<div class="vidi_catalog">
								<img src="images/design_3.jpg" alt="Световые конструкции">
							</div>
							<div class="vidi_catalog">
								<img src="images/design_4.jpg" alt="Дизайнерские шедевры">
							</div>
