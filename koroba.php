			...
			<div class="wrapper">
				...
				<main class="content">
					...
					<div class="flex">
						...
						<p>Наиболее рентабелен и практичен баннер на лицевой частью из транслюцетных материалов. Прочное полотно больших размеров неуязвимо к капризам погоды и гарантирует демонстрацию четкой картинки.</p>
