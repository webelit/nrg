...
<body>
	<div class="flex">
		...
		<div class="cont_right">
			<div class="wrapper">
				<header class="header">
					<img src="images/head_8.jpg" alt="" class="header_img">
					<div class="header_cont">
						<h1 class="h1">Интерьерная и широкоформатная<br>печать - основные различия</h1>
				...
				<main class="content">
					<div class="cont">
						<p class="rek">
							Жители мегаполисов ежедневно сталкиваются с образцами широкоформатной и интерьерной печати. Информационные вывески, стенды, афиши можно встретить и улице, и в помещении. Для каждого вида продукции требуется изображение определенного качества, которое зависит от оборудования и используемых материалов.
						</p>
						<h2 class="rek_h2">Особенности интерьерной и широкоформатной печати</h2>
						<p class="vid">Между двумя вариантами печати есть несколько принципиальных различий:</p>
					</div>
					<div class="cont">
						<div class="flex">
							<div class="vidi_catalog">
								<img src="images/print_1.jpg" alt="Уличные инсталляции">
								<p>Полиграфия для рекламы внутри помещений требует более четкого изображения с точной передачей мелких элементов и оттенков. Поэтому разрешение принтера для интерьерной печати должно быть не менее 1440 точек на дюйм, а для наружной рекламы достаточно 720 dpi.</p>
							</div>
							<div class="vidi_catalog">
								<img src="images/print_2.jpg" alt="Ландшафтные произведения искусства">
								<p>Берутся различные материалы для нанесения картинки. Для уличного использования подходит бумага, баннеры, самоклеящаяся пленка, а для комнатных отпечатков нужен холст, флизелиновые обои либо перфопленка.</p>
							</div>
							<div class="vidi_catalog">
								<img src="images/print_3.jpg" alt="Световые конструкции">
								<p>Применяются разные виды красок – для наружных работ берут стойкие сольвентные чернила, которые имеют неприятный запах, а для интерьерной полиграфии используют щадящие краски, абсолютно безопасные для здоровья.</p>
							</div>
							<div class="vidi_catalog">
								<img src="images/print_4.jpg" alt="Дизайнерские шедевры">
								<p>Широкоформатная печать размещается на открытом пространстве, поэтому продукция должна быть рассчитана на капризную погоду. Интерьерная печать применяется для оформления холлов, выставок, кафе. Способ также популярен для изготовления репродукций картин, фотообоев. Следовательно, допустима меньшая прочность основы.</p>
							</div>
