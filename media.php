...
<body>
	<div class="flex">
		...
		<div class="cont_right">
			<div class="wrapper">
				<header class="header">
					<img src="images/head_7.jpg" alt="" class="header_img">
					<div class="header_cont">
						<h1 class="h1">Светодиодные экраны – эффективный<br>инструмент рекламы</h1>
				...
				<main class="content">
					<div class="cont">
						<p class="rek">
						<strong>Светодиодные экраны</strong> – это яркий и эффективный рекламный носитель, обеспечивающий максимальный охват аудитории. Контент, транслируемый потребителям, представлен динамично и виден издалека. Большая площадь дисплея позволяет разместить довольно крупный информационный блок. В отличие от классических баннеров щиты не рвутся и не выгорают.
						</p>
						<br>
					...
					<div class="confidence">
							...
							<div class="flex adv">
								<div class="conf">
									<img src="images/conf_media_1.svg" alt="срок службы не менее 10 лет и возможность работы круглый год">
									<p>срок службы не менее 10 лет<br>и возможность работы<br>круглый год</p>
								</div>
								<div class="conf">
									<img src="images/conf_media_2.svg" alt="экономичное потребление электроэнергии">
									<p>экономичное потребление<br>электроэнергии</p>
								</div>
								<div class="conf">
									<img src="images/conf_media_3.svg" alt="простота текущего обслуживания">
									<p>простота текущего<br>обслуживания</p>
								</div>
								<div class="conf">
									<img src="images/conf_media_4.svg" alt="легкость замены демонстрируемой информации">
									<p>легкость замены<br>демонстрируемой<br>информации</p>
								</div>
								<div class="conf">
									<img src="images/conf_media_5.svg" alt="возможность передавать яркие оттенки и широкий угол обзора">
									<p>возможность передавать<br>яркие оттенки и широкий<br>угол обзора</p>
								</div>
								<div class="conf">
									<img src="images/conf_media_6.svg" alt="бесперебойное функционирование в различных климатических условиях">
									<p>бесперебойное функционирование в<br>различных климатических<br>условиях</p>
								</div>
							</div>
						</div>
					<div class="cont">
						<p class="rek">Наша компания предлагает изготовление арт-объектов на заказ. Опытные мастера создадут металлоконструкции любого формата по вашему проекту или предложат собственный небанальный вариант. Стоимость работ рассчитывается индивидуально, поскольку на цену влияют сложность каркаса, выбранные материалы, сроки исполнения заказа.</p>
					</div>
					<p class="h2">Технологический процесс изготовления</p>
					<div class="cont">
						<div class="flex adv_5">
							<div class="art">
								<img src="images/dot_3.svg" alt="dot" class="art_2_img">
								<img src="images/media_1.svg" alt="Рождение идеи или поиск интересного образа, отражающего определенную мысль." class="art_img"s>
								<p>Проектирование модели, подбор<br>деталей, составление чертежей.</p>
							</div>
							<div class="art">
								<img src="images/dot_3.svg" alt="dot" class="art_2_img">
								<img src="images/media_2.svg" alt="Выполнение эскиза и выбор оптимальных материалов." class="art_img"s>
								<p>Создание всех составляющих<br>частей.</p>
							</div>
							<div class="art">
								<img src="images/media_3.svg" alt="Доставка и установка готового изделия." class="art_img"s>
								<p>Сборка элементов и<br>тестирование систем.</p>
							</div>
						</div>
						<p class="rek">
