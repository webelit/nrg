		...
		<div class="cont_right">
			<div class="wrapper">
				...
				<main class="content">
					<div class="cont">
						<p class="rek">
							<strong>Арт-объект</strong> – это оригинальный и смелый способ привлечения внимания. Крупногабаритные конструкции придадут уникальности самому заурядному месту и сделают его центром притяжения. Только истинные мастера способны создать креативное и эстетически привлекательное сооружение, органично вписывающееся в пространство. Такие композиции призваны нести определенное послание и быть частью ландшафта.
						</p>
						<h2 class="rek_h2">Виды арт-объектов</h2>
						<p class="vidi">Современные городские инсталляции выступают интересной альтернативой привычным памятникам, ротондам и живым изгородям. Удачно подобранный арт-объект создает гармоничную атмосферу и превращается в центр притяжения людей. Композиции часто становятся традиционным местом для проведения фотосессий, поэтому конструкции адаптируют для этих целей: устанавливают помост или высаживают цветы. Наиболее популярны:</p>
					</div>
					<div class="cont">
						<div class="flex">
					...
					<p class="h2">Производство арт-объектов проходит в несколько этапов</p>
					<div class="cont">
					<div class="flex adv_5">
						<div class="art">
							<img src="images/dot_3.svg" alt="dot" class="art_2_img">
							<img src="images/art_1.svg" alt="Рождение идеи или поиск интересного образа, отражающего определенную мысль." class="art_img"s>
							<p>Рождение идеи или поиск интересного образа, отражающего определенную мысль.</p>
						</div>
						<div class="art">
							<img src="images/dot_3.svg" alt="dot" class="art_2_img">
							<img src="images/art_2.svg" alt="Выполнение эскиза и выбор оптимальных материалов." class="art_img"s>
							<p>Выполнение эскиза и выбор оптимальных материалов.</p>
						</div>
						<div class="art">
							<img src="images/dot_3.svg" alt="dot" class="art_2_img">
							<img src="images/art_3.svg" alt="Создание 3D-модели будущей инсталляции, проработка дизайна." class="art_img"s>
							<p>Создание 3D-модели будущей инсталляции, проработка дизайна.</p>
						</div>
						<div class="art">
							<img src="images/dot_3.svg" alt="dot" class="art_2_img">
							<img src="images/art_4.svg" alt="Непосредственно изготовление и заключительная обработка." class="art_img"s>
							<p>Непосредственно изготовление и заключительная обработка.</p>
						</div>
						<div class="art">
							<img src="images/art_5.svg" alt="Доставка и установка готового изделия." class="art_img"s>
							<p>Доставка и установка готового изделия.</p>
						</div>
					</div>
					</div>
					<div class="cont">
