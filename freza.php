			...
			<div class="wrapper">
				<header class="header">
					...
					<div class="header_cont">
						...
						<p>Фрезеровка рекламных материалов позволяет создать уникальный образ<br>для товара. Фигурная фрезеровка – это возможность для<br>экспериментов с дизайном и внешним видом изделия.</p>
						<div class="button">
				...
				<div class="cont">
					...
					<img src="/images/freza.png" alt="фреза">
					<div class="confidence">
							<h2 class="h2">Преимущества от фрезерных работ</h2>
							<div class="flex adv">
								<div class="conf">
