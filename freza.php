...
<body>
	<div class="flex">
		...
		<div class="cont_right">
			<div class="wrapper">
				<header class="header">
					<img src="images/head_10.jpg" alt="" class="header_img">
					<div class="header_cont">
						<h1 class="h1">Фрезеровка рекламных<br>материалов - оригинальный фирменный дизайн</h1>
						<p>Фрезеровка рекламных материалов позволяет создать уникальный инструмент<br>продвижения товара или услуги. Фигурная обработка – возможность для<br>экспериментов с дизайном</p>
						<div class="button">
				...
				<main class="content">
					<div class="cont">
						<p class="rek">
							Наружная реклама привлекает внимание броскими красками, креативными слоганами и интересными формами. С помощью фрезерной резки можно оригинально обрабатывать натуральное дерево, металл, акриловое стекло, полимеры и даже камень. Технология востребована при производстве сувенирной продукции, вывесок, объемных букв и других видов рекламы.
						</p>
						<h2 class="rek_h2">Достоинства методики</h2>
						<p class="vid">Самой актуальной сферой использования фрезерной резки является производство вывесок, фасадных табличек, букв, стел, выносных кронштейнов и логотипов для уличной и интерьерной рекламы, оформления витрин и выставочных стендов. Обработка поверхности с помощью фрезы позволяет придать объекту нужную форму и создать на этой базе неординарные и интересные, плоские или объёмные рекламные конструкции. К достоинствам метода можно отнести безупречную точность и высокую скорость обработки сырья.</p>
					</div>
					<div class="cont">
						<div class="flex">
					...
					<div class="confidence">
							...
							<div class="flex adv">
								<div class="conf">
									<img src="images/freza_1.svg" alt="срок службы не менее 10 лет и возможность работы круглый год">
									<p>разнообразие производимых<br>форм и размеров</p>
								</div>
								<div class="conf">
									<img src="images/freza_2.svg" alt="экономичное потребление электроэнергии">
									<p>долговечность изделий,<br>устойчивость к<br>механическому<br>воздействию, температурным<br>колебаниям</p>
								</div>
								<div class="conf">
									<img src="images/freza_3.svg" alt="простота текущего обслуживания">
									<p>простота ухода за готовым<br>объектом</p>
								</div>
							</div>
						</div>
					<div class="cont">
						<p class="rek">На начальном этапе разрабатывается проект будущей надписи или изображения, делается эскиз. Современное программное обеспечение фрезерных станков дает возможность изготовить сложные узоры со множеством мелких элементов. Фрезеровку допускается производить по контуру листового материала, создавая плоские фигуры либо детали, или воплощать 3D-проекты, изготавливая объемные объекты.</p>
						<p class="rek">Мы выполняем фрезеровку любых рекламных материалов по доступным ценам и в четко обозначенные сроки. Наши производственные мастерские оснащены инновационным оборудованием, точность позиционирования на станках с ЧПУ составляет 0,05 мм. Знающие специалисты имеют опыт работы с различными материалами и предельно точно воплотят вашу дизайнерскую задумку, добиваясь безупречного качества изображения и гладкости поверхности обработанных деталей.</p>
					</div>
					<div class="cont">
